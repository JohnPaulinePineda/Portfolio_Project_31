...
|
| **[Statistical Decision]** Rejection of the null hypothesis implies non-inferiority of the mean bone density treatment as compared to non-treatment, given the delta
|
| **[A]** <span style="color: #FF0000">Mean Response</span> : 2.0 to 4.0 SD at 0.20 intervals 
|
| **[B]** <span style="color: #FF0000">Reference</span> : 1.5 SD
...
| **[E]** <span style="color: #FF0000">Beta</span> : 0.30, 0.20 and 0.10 corresponding to 70%, 80% and 90% statistical powers
|
| **[F]** <span style="color: #FF0000">Delta</span> : -0.5 SD testing margin for the Test of Non-Inferiority hypothesis
|
...
|
| **[Statistical Decision]** Rejection of the null hypothesis implies equivalence of the mean bone density treatment as compared to non-treatment, given the delta
|
| **[A]** <span style="color: #FF0000">Mean Response</span> : 2.0 to 4.0 SD at 0.20 intervals 
|
| **[B]** <span style="color: #FF0000">Reference</span> : 1.5 SD
...
|      **[H.1]** Minimum testing margin to establish that the mean response is much better than reference
|      **[H.2]** Minimum testing margin to establish that the mean response is not much worse as the reference
|      **[H.3]** Minimum testing margin to establish that the mean response is no better and no worse than the reference
|
| A case scenario was provided as follows to demonstrate sample size computation and power analysis applying the different types of hypotheses:
|
...
|
| **[A]** <span style="color: #FF0000">Epsilon</span> : 5 to 12% at 1% intervals
|
...
|
| **[Research Question]** Suppose that a difference of 5 to 12% in percent change of LDL is considered clinically meaningful difference. The study aims to demonstrate that the mean LDL percent change for the first cholesterol lowering agent is not much worse than the second cholesterol lowering agent. Given a level of significance of 0.05, standard deviation of 10% and matching ratio between both groups equal to 1, evaluate the sample size range for a test of non-inferiority to achieve statistical test powers equal to 70%, 80% and 90%.
|
...
|
| **[Statistical Decision]** Rejection of the null hypothesis implies non-inferiority of the Lowering agent 1 mean LDL percent change as compared to Lowering agent 1, given the testing margin
|
| **[A]** <span style="color: #FF0000">Epsilon</span> : 5 to 12% at 1% intervals
|
| **[B]** <span style="color: #FF0000">Standard Deviation</span> : 10%
