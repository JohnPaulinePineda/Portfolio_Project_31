...
|      **[A.5]** Epsilon (Difference between Mean Response and Reference) : Higher value increases sample size
...
| Sample computation and power analysis comparison:
|
| **[A]** The minimum sample size required for each treatment group in a Two-Sample Design study is dependent upon the following factors defined and hypothesized prior to the clinical research:
|      **[A.1]** Study Hypothesis (Equality, Non-Inferiority, Superiority, Equivalence)
|      **[A.2]** Level of significance (Alpha)
|      **[A.3]** Power of the test (Beta)
|      **[A.4]** Data variability (Standard Deviation)
|      **[A.5]** Epsilon (Difference between Mean Response and Reference)
|      **[A.6]** Delta (Testing margin, as applicable)
| **[B]** Given the level of significance = 5% and mean bone density values before treatment = 1.5 SD and after treatment = 2.0 to 4.0 SD representing epsilon values = 0.5 to 2.5, the range of sample sizes is given on the respective power analyses provided for each study hypotheses -
|      **[B.1]** OSD_EQUALITY : 
|             **[B.1.1]** For 70% power, sample size = 1 to 25 
|             **[B.1.2]** For 80% power, sample size = 2 to 32 
|             **[B.1.3]** For 90% power, sample size = 2 to 43 
...
##  1.3 K-Sample Design One-Way ANOVA Pairwise (KSDOWAP)

###  1.3.1 Test for Equality (KSDOWAP_EQUALITY)
